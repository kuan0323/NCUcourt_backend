...
export default (router: Router) => {
  ...
  router.post(
    ...
    authAPI.verifyServiceToken,
    reservationAPI.createReservations
  );
  router.put(
    "/api/reservations",
    authAPI.verifyServiceToken,
    reservationAPI.editReservations
  );
  router.delete(
    "/api/reservations",
    authAPI.verifyServiceToken,
    reservationAPI.deleteReservations
  );
  ...
  router.post(
    "/api/messages",
    authAPI.verifyServiceToken,
    messageAPI.createMessages
  );
  router.put(
    "/api/messages",
    authAPI.verifyServiceToken,
    messageAPI.editMessages
  );
  router.delete(
    "/api/messages",
    authAPI.verifyServiceToken,
